      ...
      <header className="relative z-20 flex justify-between items-center px-8 py-4 bg-surface-900/60 backdrop-blur-md border-b border-surface-700/50 sticky top-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold text-white tracking-wide">Analysis History</h1>
          </div>
        </div>

        <nav className="flex items-center space-x-2">
          <button onClick={() => navigate('/home')} className="px-4 py-2 text-sm font-medium text-surface-200 hover:text-white hover:bg-surface-800/50 rounded-lg transition-all">New Analysis</button>
